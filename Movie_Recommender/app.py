...
# def fetch_poster(id_x):
#     url = "https://api.themoviedb.org/3/movie/{}?api_key=1c0fa263ee8a0a27e3e7ad0eac898e50&language=en-US".format(id_x)
...
option = st.selectbox(
    "Select a Movies which you likes",
    movie_list,
